...
<body>
    ...
    <section class="caviar-hero-area" id="dataanggota">
        ...
        <table class="table">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="editanggota.php?id=<?php echo $d['id']; ?>">EDIT</a> || 
                            <a href="hapusanggota.php?id=<?php echo $d['id']; ?>">HAPUS</a>
                        </td>
                    </tr>
                <?php 
                }
                ...
                <a href="tambahanggota.php"> <button class="btn btn-primary">Tambah Pelanggan</button></a>
        </div>
    </section>
