...
<body>
    ...
    <section class="caviar-about-us-area section-padding-100" id="dataanggota">
		<div class="container py-sm-5">
		<?php
			include 'koneksi.php';
			$id = $_GET['id'];
			$data = mysqli_query($koneksi,"select * from dataanggota where id='$id'");
		...
		<form method="post" action="updateanggota.php">
			...
			<div class="form-group">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput2" name="nama_lengkap" value="<?php echo $d['nama_lengkap']; ?>">
            </div>
            <div class="form-group">
    			<label for="formGroupExampleInput2">Posisi</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" name="posisi" value="<?php echo $d['posisi']; ?>">
            </div>
            <div class="form-group">
    			<label for="formGroupExampleInput2">Tanggal Lahir</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" name="tgl_lahir" value="<?php echo $d['tgl_lahir']; ?>">
            </div>
            <div class="form-group">
    			<label for="formGroupExampleInput2">Jenis Kelamin</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" name="jkel" value="<?php echo $d['jkel']; ?>">
            </div>
			<div>
