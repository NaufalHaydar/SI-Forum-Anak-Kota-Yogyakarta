	...
	<div class="container py-lg-3 py-sm-1">
		<form method="post" action="prosesanggota.php">
			...
			<div class="col-md-4 mb-3">
      					...
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="..." name="nama_lengkap">
    		</div>
            <div class="col-md-4 mb-3">
      					<label for="validationTooltip01">Posisi</label>
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="..." name="posisi">
    		</div>
            <div class="col-md-4 mb-3">
      					<label for="validationTooltip01">Tanggal Lahir</label>
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="..." name="tgl_lahir">
    		</div>
            <div class="col-md-4 mb-3">
      					<label for="validationTooltip01">Jenis Kelamin</label>
      					<input type="text" class="form-control" id="validationTooltip01" placeholder="..." name="jkel">
    		</div>
			<div>
